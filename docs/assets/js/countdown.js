function getDay() {
    ...
    var day_28_B = new Date(Date.UTC(2025, 7, 28, 4, 30, 0));
    day_28_B = Date.parse(day_28_B) / 1000;

    var day_28_E = new Date(Date.UTC(2025, 7, 28, 20, 45, 0));
    day_28_E = Date.parse(day_28_E) / 1000;

    var day_find1_B = new Date(Date.UTC(2025, 7, 30, 6, 0, 0));
    day_find1_B = Date.parse(day_find1_B) / 1000;

    var day_find1_E = new Date(Date.UTC(2025, 7, 30, 20, 30, 0));
    day_find1_E = Date.parse(day_find1_E) / 1000;

    var day_find2_B = new Date(Date.UTC(2025, 7, 31, 4, 30, 0));
    day_find2_B = Date.parse(day_find2_B) / 1000;

    var day_find2_E = new Date(Date.UTC(2025, 7, 31, 20, 10, 0));
    day_find2_E = Date.parse(day_find2_E) / 1000;

    var day_find3_B = new Date(Date.UTC(2025, 8, 6, 5, 15, 0));
    day_find3_B = Date.parse(day_find3_B) / 1000;

    var day_find3_E = new Date(Date.UTC(2025, 8, 6, 13, 50, 0));
    day_find3_E = Date.parse(day_find3_E) / 1000;

    var day_7_B = new Date(Date.UTC(2025, 8, 7, 15, 20, 0));
    day_7_B = Date.parse(day_7_B) / 1000;

    var day_7_E = new Date(Date.UTC(2025, 8, 7, 23, 0, 0));
    day_7_E = Date.parse(day_7_E) / 1000;

    var day_8_B = new Date(Date.UTC(2025, 8, 8, 6, 30, 0));
    day_8_B = Date.parse(day_8_B) / 1000;

    var day_8_E = new Date(Date.UTC(2025, 8, 8, 13, 30, 0));
    day_8_E = Date.parse(day_8_E) / 1000;

    var day_oct_B = new Date(Date.UTC(2025, 8, 14, 8, 10, 0));
    day_oct_B = Date.parse(day_oct_B) / 1000;

    var day_oct_E = new Date(Date.UTC(2025, 8, 15, 0, 30, 0));
    day_oct_E = Date.parse(day_oct_E) / 1000;

    var day_nextyear = new Date(Date.UTC(2026, 7, 28, 4, 0, 0));
    ...
    if (now > day_oct_E) {
        ...
        name = "¡Nos vemos en San Agustín 2026! Aún quedan:"
        ...
        name = "¡Es el día de la octava! Hoy conoceremos al nuevo niñ@ de la bandera 2026:"
        ...
        endTime = day_28_B
        name = "¡Ya casi es San Agustín 2025!"
        document.getElementById("fireworks").remove();
    }
